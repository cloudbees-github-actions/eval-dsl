...
/* harmony import */ var _actions_http_client__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(6255);
/* harmony import */ var _rainbow_js__WEBPACK_IMPORTED_MODULE_5__ = __nccwpck_require__(6596);
...
_actions_core__WEBPACK_IMPORTED_MODULE_3__.info((0,_rainbow_js__WEBPACK_IMPORTED_MODULE_5__/* .yellow */ .er)("Read the inputs ......"));

let parametersJSON;

const dsl = _actions_core__WEBPACK_IMPORTED_MODULE_3__.getInput('dsl');
const pathToDSLFile = _actions_core__WEBPACK_IMPORTED_MODULE_3__.getInput('dsl-file');
const parametersYAML = _actions_core__WEBPACK_IMPORTED_MODULE_3__.getInput('dsl-args');
const actualParameterYAML = _actions_core__WEBPACK_IMPORTED_MODULE_3__.getInput('dsl-actual-parameter');

const ignoreUnverifiedCert = _actions_core__WEBPACK_IMPORTED_MODULE_3__.getBooleanInput('ignore-unverified-cert');
...
if (parametersYAML) {
    parametersJSON = yaml__WEBPACK_IMPORTED_MODULE_1__.parse(parametersYAML);
}

if (parametersJSON) {
  Object.keys(parametersJSON).forEach(key => {
    if (typeof parametersJSON[key] === "string") {
      parametersJSON[key] = yaml__WEBPACK_IMPORTED_MODULE_1__.parse(parametersJSON[key]);
    }
  });

  if (actualParameterYAML) {
    parametersJSON.actualParameter = yaml__WEBPACK_IMPORTED_MODULE_1__.parse(actualParameterYAML);
  }
}

_actions_core__WEBPACK_IMPORTED_MODULE_3__.info((0,_rainbow_js__WEBPACK_IMPORTED_MODULE_5__/* .cyan */ .sl)("The inputs are successfully read!\n"));
// End read inputs
...
// Define DSL body
_actions_core__WEBPACK_IMPORTED_MODULE_3__.info((0,_rainbow_js__WEBPACK_IMPORTED_MODULE_5__/* .yellow */ .er)("Read DSL file ......"));

const DSLBody = dsl || await fs__WEBPACK_IMPORTED_MODULE_0__.promises.readFile(pathToDSLFile, "utf-8");
...
_actions_core__WEBPACK_IMPORTED_MODULE_3__.info((0,_rainbow_js__WEBPACK_IMPORTED_MODULE_5__/* .yellow */ .er)("Send request to get the CD/RO session ......"));
...
try {
  ...
  if (statusCode === 200 && result) {
    ...
    _actions_core__WEBPACK_IMPORTED_MODULE_3__.info((0,_rainbow_js__WEBPACK_IMPORTED_MODULE_5__/* .cyan */ .sl)("The CD/RO session is successfully received!\n"));
  } else {
    _actions_core__WEBPACK_IMPORTED_MODULE_3__.setFailed(`Session is not received; Response status code: ${statusCode}; Response body: ${result}`);
  }
} catch (error) {
...
// Evaluate DSL
_actions_core__WEBPACK_IMPORTED_MODULE_3__.info((0,_rainbow_js__WEBPACK_IMPORTED_MODULE_5__/* .yellow */ .er)("Send request to evaluate DSL ......"));
...
try {
  ...
  if (statusCode === 200 && result) {
    _actions_core__WEBPACK_IMPORTED_MODULE_3__.info(JSON.stringify(result));
    _actions_core__WEBPACK_IMPORTED_MODULE_3__.setOutput("response", result);

    _actions_core__WEBPACK_IMPORTED_MODULE_3__.info((0,_rainbow_js__WEBPACK_IMPORTED_MODULE_5__/* .cyan */ .sl)("DSL is successfully evaluated!"));
  } else {
    _actions_core__WEBPACK_IMPORTED_MODULE_3__.setFailed(`Session is not received; Response status code: ${statusCode}; Response body: ${result}`);
  }
...
/* harmony export */   "sl": () => (/* binding */ cyan)
/* harmony export */ });
